package com.estore.productservice.common.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ProductService.InsufficientStockException.class)
    public ResponseEntity<ErrorResponse> handleInsufficientStock(ProductService.InsufficientStockException ex) {
        ErrorResponse error = new ErrorResponse(
